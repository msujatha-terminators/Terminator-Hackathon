...
Review Based Quality check for use of public places post covid19 lockdown
...
Test name for Project: Review-based Quality Check for use of Public places post-Lockdown

Brief description: An application that lets you determine if a place is safe to visit or not post lockdown
...
Estimated duration for complete project compared to prototype: About one week
