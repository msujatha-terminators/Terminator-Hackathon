package com.hackathon.terminators.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.hackathon.terminators.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.hackathon.terminators.model" });
